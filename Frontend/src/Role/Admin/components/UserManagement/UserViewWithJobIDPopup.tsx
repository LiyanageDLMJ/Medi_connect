...
export function UserViewPopup({
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await axios.patch(`http://localhost:3000/api/admin/doctors/${user._id}`);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {user.name && (
              <div>
                ...
                <input type="text" value={user.name} disabled className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700" />
              </div>
            )}
            {/* Email */}
            <div>
            ...
            {user.profession && (
              <div>
                ...
                <input type="text" value={user.profession} disabled className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700" />
              </div>
            )}
            {/* Specialty */}
            {user.specialty && (
              <div>
                ...
                <input type="text" value={user.specialty} disabled className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700" />
              </div>
            )}
            {/* Location */}
            {user.location && (
              <div>
                ...
                <input type="text" value={user.location} disabled className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700" />
              </div>
            )}
            {/* Higher Education */}
            {user.higherEducation && (
              <div>
                ...
                <input type="text" value={user.higherEducation} disabled className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700" />
              </div>
            )}
            {/* School */}
            {user.school && (
              <div>
                ...
                <input type="text" value={user.school} disabled className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700" />
              </div>
            )}
            {/* Current Institute */}
            {user.currentInstitute && (
              <div>
            ...
            {user.age !== undefined && user.age !== null && (
              <div>
                ...
                <input type="number" value={user.age} disabled className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700" />
              </div>
            )}
            {/* Bio */}
            {user.bio && (
              <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4 shadow-sm">
                <div className="text-xs text-blue-700 font-semibold mb-1">Bio</div>
                <div className="text-gray-700 whitespace-pre-line">{user.bio}</div>
              </div>
            )}
          </div>
          {/* Meta Info Section */}
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div>
            ...
            <div>
              ...
              <span className="font-semibold text-sm">{user.createdAt ? new Date(user.createdAt).toLocaleString() : 'N/A'}</span>
            </div>

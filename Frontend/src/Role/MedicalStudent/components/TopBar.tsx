      ...
      <div className="flex items-center gap-2">
        ...
        >
          <img 
            src={
              user?.profilePic ||
              `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || user?.email || 'User')}&background=E0F2FE&color=0369A1&size=96&rounded=true`
            }
            alt="avatar" 
            className="w-9 h-9 rounded-full border border-gray-300 object-cover"
            onError={e => {
              e.currentTarget.onerror = null;
              e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || user?.email || 'User')}&background=E0F2FE&color=0369A1&size=96&rounded=true`;
            }}
          />
